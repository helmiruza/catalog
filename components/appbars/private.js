...
class AppbarPrivate extends React.Component {
  state = {
    anchorEl: null
  }
        ...
        <Toolbar className={classes.toolbar}>
          <div className={classes.toolbarContent}>
            ...
            <div className={classes.iconsRight}>
              <IconButton style={{color: 'black'}} onClick={this.props.handleDrawerOpen}>
                <MenuIcon />
              </IconButton>
            </div>
          </div>
...
export default withRouter(withStyles(useStyles)(AppbarPrivate))
